...
class StableDiffusionXLControlNetUnionImg2ImgPipeline2(
    DiffusionPipeline,
    ...
    def __call__(
        ...
        **kwargs,
        ...
        Args:
            ...
            control_image_list (`torch.FloatTensor`, `PIL.Image.Image`, `np.ndarray`, `List[torch.FloatTensor]`, `List[PIL.Image.Image]`, `List[np.ndarray]`,:
                    `List[List[torch.FloatTensor]]`, `List[List[np.ndarray]]` or `List[List[PIL.Image.Image]]`):
